const listCard = [
  {
      ...
      price: 3500,
      description: "Голосовой робот используется в медицинских клиниках и центрах здоровья для подтверждения записи на прием к врачу и напоминания о следующем визите.",
      list: [
  ...
  },
  {
      ...
      priceFull: "СТОИМОСТЬ маленькой коробки для БАНКА с оповещением до 1000 клиентов в день — 3500 руб. /мес.",
      connection: "free",
      integration: "absence",
      addition: ["Управление роботом через ЛК или он внедряется в CRM.", "Если клиентов у БАНКА много, можно подключить коробку с оповещением до 10 тысяч клиентов в день за 9500 руб./мес."]
  },
  {
      ...
      priceFull: "СТОИМОСТЬ ЛИДОГЕНЕРАЦИИ роботом от 6700 руб./мес. (от 5000 номеров/день) ",
  ...
  },
  {
      ...
      priceFull: "СТОИМОСТЬ оповещения до 100 клиентов САЛОНА КРАСОТЫ в день – 2100 руб. в месяц!",
      connection: "free",
      integration: "absence",
      addition: ["Если у вас СЕТЬ САЛОНОВ КРАСОТЫ – напишите Боту, вышлем спец. условия)",]
  },
  {
      ...
      priceFull: "СТОИМОСТЬ — оповещение до 100 клиентов МАГАЗИНА в день + хранение записи разговоров 10 Гб — 3500 руб./мес.",
      connection: "free",
      integration: "individ",
      addition: [],
  },
  {
      ...
      priceFull: "СТОИМОСТЬ коробки для ФИТНЕС-клуба от 2500 руб./мес. за обзвон до 1000 номеров в день",
      connection: "free",
      integration: "false",
      addition: ["Если у вас СЕТЬ ФИТНЕС-ЦЕНТРОВ – напишите Боту, вышлем спец. условия)",]
  },
  {
      ...
      priceFull: "СТОИМОСТЬ коробки для Управляющих Компаний и ЖКХ от 2400 руб./мес. (от 500 номеров/день)",
      connection: "individ",
      integration: "individ",
  ...
  },
  {
      ...
      price: 2700,
      description: "В этой коробке голосовой робот Бот N. решает ЗАДАЧИ для автосалонов, автосервисов и СТО:",
      list: [
      ...
      priceFull: "СТОИМОСТЬ МАЛЕНЬКОЙ КОРОБКИ для АВТОБИЗНЕСА с оповещением до 100 клиентов в день – 2700 руб. в месяц ",
      connection: "freeStorage",
      integration: "absence",
      addition:[ "Бот N. может действовать без контроля Человека, если будет настроена интеграция с CRM. Робот запишет разговор, и при необходимости соединит с оператором."]
  ...
  },
  {
      ...
      price: 1800,
      description: "Бот N. актуализирует статус номера (действует/не действует), распознавание речи с высокой точностью определит статус «человек/автоответчик» и тем самым повышает количество обработанных вызовов в день.",
      list: [
          "без передачи голосового сообщения",
          "3 цикла повторов",
          "удобный отчёт со статусами номеров"
      ],
      priceFull: "СТОИМОСТЬ фильтрации базы номеров (от 1000 номеров в день) – от 1800 руб. в месяц",
      connection: "free",
      integration: "absence",
      addition: [],
  },
